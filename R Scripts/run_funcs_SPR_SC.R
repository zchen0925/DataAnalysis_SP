...
raw_SPR_SC_acc <- accuracy_by_cond(data = raw_SPR_SC, acc_conds = ALL_CONDS, within_subject = FALSE)
plot_acc(acc.data = raw_SPR_SC_acc, conds = ALL_CONDS, rounding_decimal = 2, title = "Raw Accuracy",within_subject = FALSE)
plot_acc(acc.data = raw_SPR_SC_acc, conds = CONDS, rounding_decimal = 2, title = "Raw Accuracy",within_subject = FALSE)
raw_SPR_SC_acc_ind <- accuracy_by_cond(data = raw_SPR_SC, acc_conds = ALL_CONDS, within_subject = TRUE)
plot_acc(acc.data = raw_SPR_SC_acc_ind, conds = c('FL'), rounding_decimal = 3, title = "Filler Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
plot_acc(acc.data = raw_SPR_SC_acc_ind, conds = CONDS1, rounding_decimal = 1, title = "Individual Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
plot_acc(acc.data = raw_SPR_SC_acc_ind, conds = c('GP', 'NG'), rounding_decimal = 1, title = "GP, NG Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
plot_acc(acc.data = raw_SPR_SC_acc_ind, conds = c('MV', 'NMV'), rounding_decimal = 1, title = "MV, NMV Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
...
plot_perc_excluded(raw_data = raw_SPR_SC, filtered_data = segs_replaced, conds = c("GP","NG","MV","NMV"),remain_or_lost = "lost",title = "Final Segment RT after outlier replacement/nDenominator: raw results/nIncluded % from step 1",dropped_single_seg = TRUE,within_subject = FALSE)
...
crit.rt <- crit_rt(data=S_step1_3SD_SPR_SC,segs = GP_CRIT, by_seg = TRUE, within_subject = TRUE)
plot_crit_rt(data = S_step1_3SD_SPR_SC,segs = list(c('GP','seg07'), c('NG','seg08')), by_seg = TRUE, title = "Filtered GP, NG critical segs RT", within_subject = TRUE)
plot_crit_rt(data = S_step1_3SD_SPR_SC,segs = list(c('GP','seg08'), c('NG','seg09')), by_seg = TRUE, title = "Filtered GP, NG first posterior seg RT", within_subject = TRUE)
plot_crit_rt(data = S_step1_3SD_SPR_SC,segs = list(c('GP','seg09'), c('NG','seg10')), by_seg = TRUE, title = "Filtered GP, NG second posterior seg RT", within_subject = TRUE)
plot_crit_rt(data = S_step1_3SD_SPR_SC,segs = list(c('GP','seg08'),c('GP','seg09'), c('NG','seg09'),c('NG','seg10')), by_seg = TRUE, title = "GP posterior (seg08,seg09) vs NG posterior (seg09,seg10) RT", within_subject = TRUE)


#===========After step3
resp_boxplot(data = final_SPR_SC_Q, title = "Filtered GP, NGP Question Response Time", conds = c("GP","NG"),within_subject = FALSE)
resp_boxplot(data = final_SPR_SC_Q, title = "Filtered GP, NGP Question Response Time", conds = c("GP","NG"),within_subject = TRUE)

filtered_SPR_SC_acc_ind <- accuracy_by_cond(data = final_SPR_SC_Q, acc_conds = ALL_CONDS, within_subject = TRUE)
plot_acc(acc.data = filtered_SPR_SC_acc_ind, conds = c('GP', 'NG'), rounding_decimal = 1, title = "Filtered GP, NG Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
plot_acc(acc.data = filtered_SPR_SC_acc_ind, conds = c('MV', 'NMV'), rounding_decimal = 1, title = "Filtered MV, NMV Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
filtered_SPR_SC_acc <- accuracy_by_cond(data = final_SPR_SC_Q, acc_conds = ALL_CONDS, within_subject = FALSE)
plot_acc(acc.data = filtered_SPR_SC_acc, conds = c('GP', 'NG'), rounding_decimal = 1, title = "Filtered GP, NG Accuracy within Condition",within_subject = FALSE, by_id = TRUE)
plot_acc(acc.data = filtered_SPR_SC_acc, conds = c('GP', 'NG','MV','NMV'), rounding_decimal = 1, title = "Filtered GP, NG Accuracy within Condition",within_subject = FALSE, by_id = TRUE)



#============FILTERED PLOTS
#============critical seg RT=======
#crit.rt <- crit_rt(data=final_SPR_SC_S,segs = CRIT_SEGMENTS, by_seg = TRUE, within_subject = TRUE)
plot_crit_rt(data = final_SPR_SC_S,segs = list(c('GP','seg07'), c('NG','seg08')), by_seg = TRUE, title = "FILTERED GP, NG critical segs RT", within_subject = TRUE)
rt_boxplot(data = final_SPR_SC_S, title = "FILTERED GP seg07 (critical segment) vs NG seg08 (control) RT",segs = list(c('GP','seg07'), c('NG','seg08')), by_seg = TRUE, within_subject = TRUE)

rt_boxplot(data = final_SPR_SC_S, title = "FILTERED GP seg07 (critical segment) vs NG seg08 (control) RT",segs = list(c('GP','seg07'), c('NG','seg08')), by_seg = TRUE, within_subject = FALSE)

rt_boxplot(data = final_SPR_SC_S, title = "FILTERED GP posterior (seg08,seg09) vs NG posterior (seg09,seg10) RT",segs = list(c('GP','seg08'),c('GP','seg09'), c('NG','seg09'),c('NG','seg10')), by_seg = FALSE, within_subject = TRUE)

rt_boxplot(data = final_SPR_SC_S, title = "FILTERED GP before region (seg04,seg05,seg06) vs NG before region (seg05,seg06,seg07) RT",segs = list(c('GP','seg04'),c('GP','seg05'),c('GP','seg06'), c('NG','seg05'),c('NG','seg06'),c('NG','seg07')), by_seg = FALSE, within_subject = TRUE)

rt_boxplot(data = final_SPR_SC_S, title = "FILTERED GP vs NG Crit+Posterior RT",segs = list(c('GP','seg07'), c('NG','seg08'),c('GP','seg08'),c('GP','seg09'), c('NG','seg09'),c('NG','seg10')), by_seg = FALSE, within_subject = TRUE)

rt_boxplot(data = final_SPR_SC_S, title = "FILTERED GP vs NG Crit+Posterior RT",segs = list(c('GP','seg07'), c('NG','seg08'),c('GP','seg08'),c('GP','seg09'), c('NG','seg09'),c('NG','seg10')), by_seg = FALSE, within_subject = FALSE)
