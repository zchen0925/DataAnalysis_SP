...
#====================
# 
# crit.rt <- crit_rt(data=S_step2_3SD_SPR_SC,segs = GP_CRIT, by_seg = TRUE, within_subject = TRUE)
# plot_crit_rt(data = S_step2_3SD_SPR_SC,segs = list(c('GP','seg07'), c('NG','seg08')), by_seg = TRUE, title = "Filtered GP, NG critical segs RT", within_subject = TRUE)
# plot_crit_rt(data = S_step2_3SD_SPR_SC,segs = list(c('GP','seg08'), c('NG','seg09')), by_seg = TRUE, title = "Filtered GP, NG first posterior seg RT", within_subject = TRUE)
# plot_crit_rt(data = S_step2_3SD_SPR_SC,segs = list(c('GP','seg09'), c('NG','seg10')), by_seg = TRUE, title = "Filtered GP, NG second posterior seg RT", within_subject = TRUE)
# plot_crit_rt(data = S_step2_3SD_SPR_SC,segs = list(c('GP','seg08'),c('GP','seg09'), c('NG','seg09'),c('NG','seg10')), by_seg = TRUE, title = "GP posterior (seg08,seg09) vs NG posterior (seg09,seg10) RT", within_subject = TRUE)
# 
# 
# #===========After step3
...
raw_acc <- accuracy_by_cond(data = raw_SPL_SC, acc_conds = ALL_CONDS, within_subject = FALSE)
plot_acc(acc.data = raw_acc, conds = ALL_CONDS, rounding_decimal = 2, title = "Raw Accuracy",within_subject = FALSE)
plot_acc(acc.data = raw_acc, conds = CONDS, rounding_decimal = 2, title = "Raw Accuracy",within_subject = FALSE)
raw_acc_ind <- accuracy_by_cond(data = raw_SPL_SC, acc_conds = ALL_CONDS, within_subject = TRUE)
plot_acc(acc.data = raw_acc_ind, conds = c('FL'), rounding_decimal = 3, title = "Filler Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
#plot_acc(acc.data = raw_acc_ind, conds = CONDS1, rounding_decimal = 1, title = "Individual Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
plot_acc(acc.data = raw_acc_ind, conds = c('GP', 'NG'), rounding_decimal = 1, title = "GP, NG Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
plot_acc(acc.data = raw_acc_ind, conds = c('MV', 'NMV'), rounding_decimal = 1, title = "MV, NMV Accuracy within Condition",within_subject = TRUE, by_id = TRUE)
...
# Q_raw <- subset(raw_SPL_SC, Seg == 'question')
# Q_raw$Count <- 1
...
#============================================Segment filtering============================================
# S_raw <- subset(raw_SPL_SC, Seg != 'question')
# S_raw$Count <- 1
...
# S_step3_0.2truncate_SPL_SC <- subset(S_step2_3SD_SPL_SC, 
#                                      (
#                                        (
#                                          (
...
# )
# 
# truncated_SPL_list <- subset(S_step2_3SD_SPL_SC, 
#                              (
#                                (
#                                  (
#                                    ((CONDITION %in% c('GP','MV','NMV')) & (Seg %in% c('seg06', 'seg07','combined_crit')))
...
#plot_perc_excluded(raw_data = raw_SPL_SC, filtered_data = truncated_SPL_list, digits = 0.1,conds = c("GP","NG"),remain_or_lost = "lost",title = "% GP, NG segment truncated for more than 20% excluded", dropped_single_seg = TRUE,within_subject = TRUE)
#plot_perc_excluded(raw_data = raw_SPL_SC, filtered_data = truncated_SPL_list, digits = 0.1, conds = c("MV","NMV"),remain_or_lost = "lost",title = "% MV, NMV segment truncated for more than 20% excluded",dropped_single_seg = TRUE,within_subject = TRUE)
#plot_perc_excluded(raw_data = S_step2_3SD_SPL_SC, filtered_data = truncated_SPL_list, conds = c("GP","NG","MV","NMV"),remain_or_lost = "lost",title = "% Indv segs truncated for more than 20% excluded",dropped_single_seg = TRUE,within_subject = FALSE)
